"""This scripts generates 3 examples where we regress HR T1 scans from LR T1 and T2 scans. We assume here that HR
label maps are available with corresponding T1 scans. Thus this script produces pairs of real HR T1 scans along with
aligned HR synthetic scans (input channels) simulating T1 and T2 scans acquired at LR."""
...
# general parameters
channels = 2  # we generate 2 synthetic channel (LR T1 and T2 scans).
